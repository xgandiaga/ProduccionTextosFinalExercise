...
\begin{table}[h]
    ...
    \begin{tabular}{llrlr}
    \hline
    Characteristics     &  & \begin{tabular}[c]{@{}r@{}}Struck\Tstrut\\ Passenger ship\Bstrut\end{tabular} &  & \begin{tabular}[c]{@{}r@{}}Striking\Tstrut\\ Cargo ship\Bstrut\end{tabular} \\ \hline
    Length over all (m)\Tstrut &  & 85.92                                                           &  & 144.50                                                        \\
    Breadth moulded (m) &  & 15.00                                                           &  & 19.80                                                         \\
    Design draft (m)    &  & 4.30                                                            &  & 5.60                                                          \\
    Depth (m)           &  & 10.40                                                           &  & 10.20                                                         \\
    Frame spacing (m)\Bstrut   &  & 0.60                                                            &  & -                                                             \\ \hline
    \end{tabular}
\end{table}


The detail dimension for both ships are presented in \hyperref[table1]{Table 1}. Ship models of the struck and striking ships are presented in \hyperref[fig1]{Fig. 1}.
\\
...
failure strain, and hardening type had been selected as parameters in material level. Detail description regarding these configurations are presented consecutively in \hyperref[table2]{Table 2}. 
...
\begin{table}
    \caption{Detail of scenario models.}
    \label{table2}
    \begin{tabular}{llll}
    \hline 
    Parameters\Tstrut\Bstrut & Impact scenario model & \\
    \hline 
    Structural\Tstrut & Double hull & Space width (m) & $1.50$ \\
    & & & $3.50$ \\
